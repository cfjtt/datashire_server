...
public final class DbUtils {
    ...
    public static void closeQuietly(Connection conn) {
        try {
            ...
            // quiet
        	logger.error("close err!", e); // Quietly but need a log
        }
    }
    ...
    public static void commitAndCloseQuietly(Connection conn) {
        try {
            ...
            // quiet
        	logger.error("commit or close err!", e); // Quietly need a log
        }
		logger.debug("commitAndCloseQuietly ok ! "+conn);
    }
