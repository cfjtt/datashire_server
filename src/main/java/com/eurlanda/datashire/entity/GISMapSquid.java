 ...
 *
 */
@MultitableMapping(name = {"DS_SQUID", "DS_GIS_MAP_SQUID"},pk="ID", desc = "")
public class GISMapSquid extends Squid {
	{
		this.setType(DSObjectType.GISMAP.value());
	}
	// 是否是实时报表
	...
	@ColumnMpping(name="map_name", desc="", nullable=true, precision=100, type=Types.VARCHAR, valueReg="")
	private String map_name;
	// 报表模板定义
	@ColumnMpping(name="map_template", desc="", nullable=true, precision=100, type=Types.CLOB, valueReg="")
	private String map_template;
	// 文件夹ID
	...
	/**
	 * @return the map_template
	 */
	public String getMap_template() {
		return map_template;
	}

	/**
	 * @param map_template the report_template to set
	 */
	public void setMap_template(String map_template) {
