...
public class DbSquid extends Squid {
	...
	private int state;
	@ColumnMpping(name="course_id", desc="", nullable=true, precision=100, type= Types.INTEGER, valueReg="")
	...
	public String toString() {
		return "DbSquid [db_name=" + db_name + ", host=" + host + ", password="
