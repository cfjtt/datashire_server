 ...
 * @date 2014-4-29
 */
public class WebExtractSquid extends DataSquid {
    public WebExtractSquid(){
        
    }

    {
        this.setType(DSObjectType.WEBEXTRACT.value());
    }
    
    public WebExtractSquid(DataSquid dataSquid) {
