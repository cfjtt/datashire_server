...
public class DateUtil {
	...
	public static final DateFormat DATE_FULL_TIME_FORMAT= new SimpleDateFormat(
			"yyyy-MM-dd HH:mm:ss");

	public static final DateFormat DATE_TIME_FORMAT = new SimpleDateFormat(
			"yyyy-MM-dd HH:mm");

	public static final DateFormat DATE_HOUR_TIME_FORMAT = new SimpleDateFormat(
			"yyyy-MM-dd HH");

	public static final DateFormat SIMPLE_DOT_FORMATTER = new SimpleDateFormat(
			"yyyy.MM");
	 ...
	 * @return Date (value/null)
	 */
	public static Date parseHM(String dateString,String formatString) {
		Date date = null;
		try {
	DateFormat simpleDotFormatter = new SimpleDateFormat(formatString);
			date = simpleDotFormatter.parse(dateString);
		} catch (ParseException e) {
		}
		return date;
	}
	...
	public static String getDateIsStr() {
		 SimpleDateFormat formatter = new SimpleDateFormat("yyyyMMddHHmmss");
		 return formatter.format(new Date());
	}
	...
	public static void main(String[] args) {
	 ...
	 DateFormat dateFullTimeFormat_line = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
	 System.out.println(dateFullTimeFormat_line.format(new Date()));
	}
