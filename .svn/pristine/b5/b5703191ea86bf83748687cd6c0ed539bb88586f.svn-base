...
public class XLS2CSV implements HSSFListener{
    ...
    public XLS2CSV(File in, OutputStream os) throws Exception {
    ...
    public void process() throws IOException {
        ...
        /**
         * 读取xls文件时。会先将它转换为csv文件。之后再删除csv文件
         * 所以这里的操作流需要关闭。不关闭。删不掉那些临时csv文件。
         */
        if(output!=null){
            output.close();
        }
    ...
    public static void main(String[] args) throws Exception {
        XLS2CSV xls2csv = new XLS2CSV("data\\联系方式.xls","data\\out.csv");
        xls2csv.process();
    }
}
