 ...
 * @date 2014-4-29
 */
public class XmlExtractSquid extends DataSquid{
    
    public XmlExtractSquid(){
        
    }
	
	public XmlExtractSquid(DataSquid dataSquid){
...
/*    public XmlExtractSquid(SquidModelBase s){
        if(s!=null && dataSquid.getId()>0){
            this.setId(dataSquid.getId());
            this.setName(dataSquid.getName());
            this.setTable_name(dataSquid.getTable_name());
            this.setFilter(dataSquid.getFilter());
