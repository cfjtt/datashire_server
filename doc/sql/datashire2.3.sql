...
-- 增加mysql的不允许的分片控制列
update ds_sys_server_parameter set VALUE = '{"MYSQL":"BLOB,LONGBLOB,MEDIUMBLOB,TINYBLOB,XML,VARCHAR,VARBINARY","ORACLE":"BLOB,BINARY_DOUBLE,NCLOB,CLOB,BFILE,DBURITYPE,LONG,RAW,ROWID,SDO_GEOMETRY,SDO_GEORASTER,SDO_TOPO_GEOMETRY,URITYPE,UROWID,XDBURITYPE,XMLTYPE","SQLSERVER":"BINARY,VARCHAR,NVARCHAR,VARBINARY,TIMESTAMP,UNIQUEIDENTIFIER,IMAGE,XML,HIERARCHYID,TEXT,NTEXT,DATETIMEOFFSET,SQL_VARIANT,BIT,CHAR","DB2":"CLOB"}' where `NAME`='SPLIT_COLUMN_FILTER';
-- 新增SAMPLINGSQUID 2017-11-23
INSERT INTO ds_squid_type VALUES (74,76,'SAMPLINGSQUID');

-- SAMPLINGSQUID  新增属性 2017-11-23
ALTER TABLE ds_squid ADD sampling_percent double(64,15);
ALTER TABLE ds_squid ADD source_squidId int(11);
ALTER TABLE ds_squid ADD source_squidName VARCHAR(50);

-- PIVOTSQUID 2017-11-24
INSERT INTO ds_squid_type VALUES (75,77,'PIVOTSQUID');
-- PIVOTSQUID 新增属性 2017-11-24
ALTER TABLE ds_squid ADD pivot_column_value LONGTEXT;
ALTER TABLE ds_squid ADD aggregation_type int(11);
ALTER TABLE ds_squid ADD pivot_column_id int(11);
ALTER TABLE ds_squid ADD value_column_id int(11);
ALTER TABLE ds_squid ADD group_by_column_ids VARCHAR(500);
