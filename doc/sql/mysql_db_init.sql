...
ALTER TABLE DS_SQUID ADD CONSTRAINT FK_SQUID_TYPE_ID FOREIGN KEY (SQUID_TYPE_ID) REFERENCES DS_SQUID_TYPE (CODE) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
(ID INTEGER NOT NULL AUTO_INCREMENT,
 ...
 SORT_TYPE INTEGER,
  PRIMARY KEY (ID));
CREATE INDEX SYS_IDX_SYS_CT_10265_10271 ON DS_COLUMN(NAME);
...
(ID INTEGER NOT NULL AUTO_INCREMENT,
 TRAINING_PERCENTAGE DOUBLE(64,2),
 VERSIONING INTEGER,
 MIN_BATCH_FRACTION DOUBLE(64,2),
 ITERATION_NUMBER INTEGER,
 STEP_SIZE DOUBLE(64,2),
 SMOOTHING_PARAMETER DOUBLE(64,2),
 REGULARIZATION DOUBLE(64,2),
 K INTEGER,
 PARALLEL_RUNS INTEGER,
 INITIALIZATION_MODE INTEGER,
 IMPLICIT_PREFERENCES INTEGER,
 CASE_SENSITIVE INTEGER,
 MIN_VALUE DOUBLE(64,2),
 MAX_VALUE DOUBLE(64,2),
...
ALTER TABLE DS_SYS_REPOSITORY ADD CONSTRAINT FK_REP_TEAM_ID FOREIGN KEY (TEAM_ID) REFERENCES DS_SYS_TEAM (ID) ON UPDATE NO ACTION ON DELETE NO ACTION;
